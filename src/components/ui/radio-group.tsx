  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        ...
        "data-[state=unchecked]:bg-transparent", // transparent
        "data-[state=unchecked]:border-none",
        className
      )}
      {...props}
    >
...
interface BracketRadioItemProps {
  value: string;
  className?: string;
}

export const BracketRadioItem = ({
  value,
  className,
}: BracketRadioItemProps) => {
  return (
    <div
      className={cn(
        "relative flex items-center justify-center",
        "before:content-['['] before:text-[#68655F] before:text-xl ",
        "after:content-[']'] after:text-[#68655F] after:text-xl  ",
        className
      )}
    >
      <RadioGroupItem
