...
export { default as ProductCategory } from "@/components/templates/app/settings/product-category";
export { default as Pricing } from "@/components/templates/app/settings/pricing";
